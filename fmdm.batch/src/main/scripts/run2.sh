...
cnt=`ps -ef | grep "com.founder.monitor.MainApp pro2" | grep -v grep | wc -l`
if [ $cnt -gt 0 ]; then
...
$JAVA_HOME/bin/java -DINSTANCE=pro2 -cp "$CFG:$CP3" -Dlogback.configurationFile=/$CFG/logbak-pro2.xml com.founder.monitor.MainApp pro2
