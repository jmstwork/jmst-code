...
public class CSVParser {
    ...
    public static void main(String[] args){
    	String rool = "\"1,2\",\"3,4\",5,\"2323\",,ss,";
    	CSVParser s = new CSVParser();
    	CSVWriter cw = new CSVWriter();
    	try {
			String[] aa = s.parseLineMulti(rool);
			for(int i = 0;i<aa.length;i++){
				System.out.println(aa[i]);
			}
			System.out.println(rool);
			String writer = cw.writeNext2(aa, true);
			System.out.println(cw.writeNext2(aa, true));
			String[] bb = s.parseLine(writer);
			for(int i = 0;i<aa.length;i++){
